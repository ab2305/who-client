...
Check performed at Thu Jul 21 14:18:13 CST 2016.<br/>
1 errors and 2 warnings found:<br/><br/>
...
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:86</span>: <span class="message">Not targeting the latest versions of Android; compatibility modes apply. Consider testing and updating this version. Consult the android.os.Build.VERSION_CODES javadoc for details.</span><br /><pre class="errorlines">
<span class="lineno">  83</span>     defaultConfig {
<span class="lineno">  84</span>         applicationId "com.combinedbuttonexample"
<span class="lineno">  85</span>         minSdkVersion 16
<span class="lineno">  86</span>         <span class="errorspan">targetSdkVersion 22</span>
<span class="lineno">  87</span>         versionCode 1
<span class="lineno">  88</span>         versionName "1.0"
</pre>
</div>
...
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:128</span>: <span class="message">A newer version of com.android.support:appcompat-v7 than 23.0.1 is available: 24.0.0</span><br /><pre class="errorlines">
<span class="lineno"> 125</span> 
<span class="lineno"> 126</span> dependencies {
<span class="lineno"> 127</span>     compile fileTree(dir: "libs", include: ["*.jar"])
<span class="lineno"> 128</span>     <span class="errorspan">compile "com.android.support:appcompat-v7:23.0.1"</span>
<span class="lineno"> 129</span>     compile "com.facebook.react:react-native:+"  // From node_modules
